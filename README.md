...
### Pro Sales
An ASP.NET Core Web API (.NET 8) built for Customer Relationship Management — customer organization, sales tracking, and communication workflows, backed by EF Core and SQL Server.
...
A backend for running a mechanic shop's day-to-day operations — customers, vehicles, and service/work orders, modeled around a proper relational data layer.

`ASP.NET Core` `EF Core` `SQL Server`

[→ github.com/Mahmoud-Mshrf/MechanicShop](https://github.com/Mahmoud-Mshrf/MechanicShop)
